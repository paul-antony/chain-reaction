...
If the depth is equal to zero, then the board doesn't have any empty cells to play. Or, if a player wins, then the game ended for MAX or MIN. So the score for that state will be returned.
